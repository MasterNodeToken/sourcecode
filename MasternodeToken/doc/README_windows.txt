MasternodeToken Core
=====================

Intro
-----
MasternodeToken (MAST) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. MasternodeToken utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run MasternodeToken-qt.exe.

MasternodeToken Core is the original MasternodeToken client and it builds the backbone of the network.
However, it downloads and stores the entire history of MasternodeToken transactions;
