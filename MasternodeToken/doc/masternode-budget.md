...
MasternodeToken now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<MasternodeToken_address\> \<monthly_payment_MasternodeToken\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ MAST, _12_ times over the course of a year totaling _24000_ MAST.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<MasternodeToken_address\> \<monthly_payment_MasternodeToken\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` MAST.
 ...
 * vote-many          - Vote on a MasternodeToken initiative
 * vote-alias         - Vote on a MasternodeToken initiative
 * vote               - Vote on a MasternodeToken initiative/budget
