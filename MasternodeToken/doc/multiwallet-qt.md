...
In order to support loading of multiple wallets in MasternodeToken-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is MasternodeToken.cpp.
...
Changes to MasternodeToken.cpp
----------------------
MasternodeToken.cpp is the entry point into MasternodeToken-qt, and as such, will require some minor modifications to provide hooks for
