...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("MasternodeToken Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  MasternodeToken-cli [options] <command> [params]  " + _("Send command to MasternodeToken Core") + "\n" +
                        "  MasternodeToken-cli [options] help                " + _("List commands") + "\n" +
                        "  MasternodeToken-cli [options] help <command>      " + _("Get help for a command") + "\n";
