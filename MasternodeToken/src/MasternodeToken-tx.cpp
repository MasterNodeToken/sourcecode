...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasternodeToken Core MasternodeToken-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  MasternodeToken-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MasternodeToken transaction") + "\n" +
                               "  MasternodeToken-tx [options] -create [commands]   " + _("Create hex-encoded MasternodeToken transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded MasternodeToken transaction
