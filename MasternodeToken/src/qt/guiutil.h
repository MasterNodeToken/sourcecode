...
/** Utility functions used by the MasternodeToken Qt UI.
 */
namespace GUIUtil
{
...
// Render MAST addresses in monospace font
...
// Parse "MasternodeToken:" URI into recipient object, return true on successful parsing
