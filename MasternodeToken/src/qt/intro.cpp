...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MasternodeToken Core"),
     ...
     * override -datadir in the MasternodeToken.conf file in the default data directory
     * (to be consistent with MasternodeTokend behavior)
     */
    if (dataDir != getDefaultDataDirectory())
