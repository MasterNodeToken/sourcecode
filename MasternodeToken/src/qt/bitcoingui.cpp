                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MasternodeToken Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MAST address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and MasternodeToken: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MasternodeToken Core"), this);
    aboutAction->setStatusTip(tr("Show information about MasternodeToken Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MasternodeToken"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MAST addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MAST addresses"));
    ...
    openAction->setStatusTip(tr("Open a MasternodeToken: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MasternodeToken Core help message to get a list with possible MasternodeToken command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MasternodeToken Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MasternodeToken network", "", count));
}
...
{
    QString strTitle = tr("MasternodeToken Core"); // default title
    ...
    // Append title to "MasternodeToken - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
