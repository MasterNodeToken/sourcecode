...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MasternodeToken server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MasternodeToken server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MasternodeToken features */
        {"MasternodeToken", "masternode", &masternode, true, true, false},
        {"MasternodeToken", "listmasternodes", &listmasternodes, true, true, false},
        {"MasternodeToken", "getmasternodecount", &getmasternodecount, true, true, false},
        {"MasternodeToken", "masternodeconnect", &masternodeconnect, true, true, false},
        {"MasternodeToken", "masternodecurrent", &masternodecurrent, true, true, false},
        {"MasternodeToken", "masternodedebug", &masternodedebug, true, true, false},
        {"MasternodeToken", "startmasternode", &startmasternode, true, true, false},
        {"MasternodeToken", "createmasternodekey", &createmasternodekey, true, true, false},
        {"MasternodeToken", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"MasternodeToken", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"MasternodeToken", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"MasternodeToken", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"MasternodeToken", "getmasternodescores", &getmasternodescores, true, true, false},
        {"MasternodeToken", "mnbudget", &mnbudget, true, true, false},
        {"MasternodeToken", "preparebudget", &preparebudget, true, true, false},
        {"MasternodeToken", "submitbudget", &submitbudget, true, true, false},
        {"MasternodeToken", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"MasternodeToken", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"MasternodeToken", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"MasternodeToken", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"MasternodeToken", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"MasternodeToken", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"MasternodeToken", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"MasternodeToken", "checkbudgets", &checkbudgets, true, true, false},
        {"MasternodeToken", "mnsync", &mnsync, true, true, false},
        {"MasternodeToken", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> MasternodeToken-cli " + methodname + " " + args + "\n";
}
