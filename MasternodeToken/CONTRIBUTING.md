Contributing to MasternodeToken Core
==================================

The MasternodeToken Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MasternodeToken Core project, and is not to be
confused with overall MasternodeToken Network Protocol consensus changes.

Whether a pull request is merged into MasternodeToken Core rests with the project merge
...
Patches that change MasternodeToken consensus rules are considerably more involved than
...
Where a patch set proposes to change the MasternodeToken consensus, it must have been
...
The project leader is the release manager for each MasternodeToken Core release.
