...
#   c) node1 mines 32 blocks, so now node 0 has 500000MAST, node 1 has 4250MAST, node2 has none.
#   d) node0 sends 601 MAST to node2, in two transactions (301 MAST, then 300 MAST).
